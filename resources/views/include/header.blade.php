<header id="header-bg" class="text-white fixed top-0 left-0 w-full z-40 border-b border-gray-700 shadow-lg transition-colors duration-200">
  <div class="container mx-auto flex justify-between md:justify-center items-center">
    ...
    <nav class="hidden lg:text-2xl md:flex items-center space-x-12 lg:space-x-16">
      ...
      <a href="{{ route('our-services') }}" class="hover:text-gray-300 transition">Our Services</a>
      <a href="{{ route('about-us') }}" class="hover:text-gray-300 transition">About Us</a>
      <a href="#" class="hover:text-gray-300 transition">Blogs</a>
      <a href="{{ route('contact-us') }}" class="hover:text-gray-300 transition">Contact Us</a>
      <a href="#" class="hover:text-gray-300 transition flex items-center space-x-1 hidden xl:block">
        <i class="fa-solid fa-phone-volume"></i>
        <span class="">+977-01-5100223</span>
      </a>
    </nav>
