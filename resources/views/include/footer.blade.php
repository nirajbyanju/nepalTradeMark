<footer class="block md:hidden">
    <div class="flex justify-between bg-[#1C4980] fixed bottom-0 left-0 w-full p-3 z-30 border-t border-gray-300">
        ...
        <div class="flex flex-col items-center">
            <a href="{{ url('/ourServices') }}" class="flex flex-col items-center text-white">
                <div class="server-icon text-xl">
        ...
        <div class="flex flex-col items-center">
            <a href="{{ url('/about-us') }}" class="flex flex-col items-center text-white">
                <div class="server-icon text-xl">
        ...
        <div class="flex flex-col items-center">
            <a href="{{ url('/contact-us') }}" class="flex flex-col items-center text-white">
                <div class="server-icon text-xl">
        ...
        <div class="grid grid-cols-1 md:grid-cols-12 gap-10">
            ...
            <div class="md:col-span-3">
                ...
                <ul class="space-y-2">
                    ...
                    <li class="flex items-center gap-2 group hover:text-[#EAB308]">
                        <i class="fa-solid fa-circle text-[8px] group-hover:text-[#EAB308]"></i>
                        <a href="{{ url('renewal') }}" class="group-hover:text-[#EAB308]">Trademark Renewal</a>
                    </li>
                </ul>
            </div>
