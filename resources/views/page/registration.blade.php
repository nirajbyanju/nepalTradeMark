...
@section('content')
    ...
    <div class="container bg-white py-8 px-6 sm:px-12 md:px-16 lg:px-20 xl:px-24 rounded-lg shadow-lg">
        <h1 class="text-3xl font-bold mb-6 main-text-color">Filing Requirements for Trade/Service Mark Registration in Nepal</h1>
        <p class="main-text-color mb-6">The following are the essential filing requirements for trade/service mark registration in Nepal:</p>
        
        <div class="space-y-6">
            <div>
                <h2 class="text-xl font-semibold main-text-color">1. Application and Power of Attorney</h2>
                <p class="text-gray-700">Duly signed, sealed, and counter-signed by two witnesses of the applicant company.</p>
            </div>
            <div>
                <h2 class="text-xl font-semibold main-text-color">2. Certified/Notarized Copy of Registration Certificate</h2>
                <p class="text-gray-700">A certified/notarized copy of the Home/Foreign Registration Certificate of the mark in English language.</p>
                <p class="text-gray-700">Or, a notarized/certified copy of the Filing Receipt or application in English language in case of a Priority Claim application.</p>
            </div>
            <div>
            ...
            <div>
                ...
                <p class="text-gray-700">The proposed specification of goods must be identical to the Home/Foreign Registration Certificate of the mark.</p>
            </div>
        </div>
    </div>
